...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    //Images routes
    $router->get('/images', ['uses' => 'ImagesController@getImage', 'as' => 'getImage']); // Getting image with keyword
    ...
    $router->get('/keywords', ['uses' => 'WordController@showKeyword', 'as' => 'showKeyword']);

    $router->post('/categorys', ['uses' => 'CategoryController@addCategory', 'as' => 'addCategory']); // Adding new category
